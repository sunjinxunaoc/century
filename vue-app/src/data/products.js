  ...
  },
  {
    ...
    subcategories: [
      ...
      },
      {
        ...
        products: [
          {
            slug: 'v3-20-4-valve-stem',
            name: 'V3-20-4 Valve Stem',
            tagline: 'High-pressure brass metal valve stem for truck and bus. 27° bend, Φ16 x 90 mm.',
            desc: 'V3-20-4 high-pressure brass metal tyre valve stem for truck and bus applications.',
            keywords: 'V3-20-4 valve stem, truck valve, bus valve, brass metal tyre valve',
            ...
            spec: {
              ...
              rows: [['V3-20-4', 'Φ16 x 90', 'Brass', '27°']],
            },
          },
          {
            slug: 'v3-20-4n-valve-stem',
            name: 'V3-20-4N Valve Stem',
            tagline: 'High-pressure brass metal valve stem for truck and bus. 27° bend, Φ16 x 90 mm.',
            desc: 'V3-20-4N high-pressure brass metal tyre valve stem for truck and bus applications.',
            keywords: 'V3-20-4N valve stem, truck valve, bus valve, brass metal tyre valve',
            features: ['Brass construction', 'High pressure rating', '27° bent stem', 'For truck and bus'],
            spec: {
              headers: ['Model', 'Valve Hole (mm)', 'Material', 'Bent Degree'],
              rows: [['V3-20-4N', 'Φ16 x 90', 'Brass', '27°']],
            },
          },
          {
            slug: 'v3-20-6-valve-stem',
            name: 'V3-20-6 Valve Stem',
            tagline: 'High-pressure brass metal valve stem for truck and bus. 27° bend, Φ16 x 115 mm.',
            desc: 'V3-20-6 high-pressure brass metal tyre valve stem for truck and bus applications.',
            keywords: 'V3-20-6 valve stem, truck valve, bus valve, brass metal tyre valve',
            features: ['Brass construction', 'High pressure rating', '27° bent stem', 'For truck and bus'],
            spec: {
              headers: ['Model', 'Valve Hole (mm)', 'Material', 'Bent Degree'],
              rows: [['V3-20-6', 'Φ16 x 115', 'Brass', '27°']],
            },
          },
          {
            slug: '58ms-valve',
          ...
          {
            slug: 'tr570-valve-stem',
            name: 'TR570 Valve Stem',
            tagline: 'Brass metal valve stem, ref V3.21.4, Φ19 x 84 mm. TR570-TR572 family for truck and bus.',
            desc: 'TR570 brass metal tyre valve stem (ref V3.21.4) for truck and bus applications.',
            keywords: 'TR570 valve stem, V3.21.4, truck valve, bus valve, brass metal tyre valve',
            features: ['Brass construction', 'High pressure rating', 'TR570-TR572 series', 'For truck and bus'],
            spec: {
              headers: ['Model', 'Ref. No.', 'Eff. Length (mm)', 'Material', 'Bent Degree'],
              rows: [
                ...
                ['TR570C', 'V3.21.9', 'Φ19 x 84', 'Brass', '90° or 27°'],
          ...
          {
            slug: 'tr571-valve-stem',
            name: 'TR571 Valve Stem',
            tagline: 'Brass metal valve stem, ref V3.21.5, Φ19 x 90 mm. TR570-TR572 family for truck and bus.',
            desc: 'TR571 brass metal tyre valve stem (ref V3.21.5) for truck and bus applications.',
            keywords: 'TR571 valve stem, V3.21.5, truck valve, bus valve, brass metal tyre valve',
            features: ['Brass construction', 'High pressure rating', 'TR570-TR572 series', 'For truck and bus'],
            spec: {
              headers: ['Model', 'Ref. No.', 'Eff. Length (mm)', 'Material', 'Bent Degree'],
              rows: [
          ...
          {
            slug: 'tr572-valve-stem',
            name: 'TR572 Valve Stem',
            tagline: 'Brass metal valve stem, ref V3.21.6, Φ19 x 100 mm. NAPA replacement reference.',
            desc: 'TR572 brass metal tyre valve stem (ref V3.21.6) for truck and bus applications.',
            keywords: 'TR572 valve stem, V3.21.6, TR572 NAPA, truck valve, bus valve, brass metal tyre valve',
            features: ['Brass construction', 'High pressure rating', 'TR570-TR572 series', 'NAPA replacement reference'],
            spec: {
              headers: ['Model', 'Ref. No.', 'Eff. Length (mm)', 'Material', 'Bent Degree'],
              rows: [
                ['TR570', 'V3.21.4', 'Φ19 x 84', 'Brass', '—'],
          ...
          {
            slug: 'tr571c-valve-stem',
            name: 'TR571C Valve Stem',
            tagline: 'Brass metal valve stem, ref V3.21.10, Φ19 x 90 mm. 90° or 27° bend.',
            desc: 'TR571C brass metal tyre valve stem (ref V3.21.10) for truck and bus applications.',
            keywords: 'TR571C valve stem, V3.21.10, truck valve, bus valve, brass metal tyre valve',
          ...
          {
            slug: 'tr572c-valve-stem',
            name: 'TR572C Valve Stem',
            tagline: 'Brass metal valve stem, ref V3.21.11, Φ19 x 100 mm. 90° or 27° bend.',
            desc: 'TR572C brass metal tyre valve stem (ref V3.21.11) for truck and bus applications.',
            keywords: 'TR572C valve stem, V3.21.11, truck valve, bus valve, brass metal tyre valve',
            features: ['Brass construction', 'High pressure rating', '90° or 27° bend', 'TR570-TR572 series'],
            spec: {
              headers: ['Model', 'Ref. No.', 'Eff. Length (mm)', 'Material', 'Bent Degree'],
              rows: [
